...
<head>
    ...
    <title>Student Login - Career Counseling & Guide Portal</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.html">
                <i class="fas fa-book-open"></i>Career Portal
            </a>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <form method="POST" action="Log-in (Student).php" id="loginForm">
                <!-- Email -->
                ...
                <div class="admin-link">
                    <p><a href="Log-in (Admin).php">Login as Administrator</a></p>
                </div>
            </form>
        </div>
    </div>
